...
if($envType -eq "prod"){
	$siteUri = "http://viewer-api.sarine.com/cache/v2/atom/sarine.viewer.gemprint"
}
else{
	$siteUri = "http://viewer-api-$envId.$envName.sarine.com/cache/v2/atom/sarine.viewer.gemprint"
}
